            ...
            <div className="container 2xl mt-10">
                ...
                <div className="grid grid-cols-3 my-4 mx-14 bg-green-sub-custom">
                    <div className="grid grid-cols-1 col-span-2 justify-content-center my-3 mx-3">
                        <div className="flex justify-content-center relative max-h-72">
                            ...
                            <div className="bg-white text-center absolute bottom-0 right-0 py-2 px-3 m-1">
                                <h5>Toán</h5>
                                <small className="text-cyan-400">49 Khoá</small>
                            </div>
                        ...
                        <div className="flex justify-content-center mt-3">
                            <div className="flex-col mr-1 w-1/2 relative max-h-60">
                                ...
                                <div className="bg-white text-center absolute bottom-0 right-0 py-2 px-3 m-1">
                                    <h5>Vật lí</h5>
                                    <small className="text-cyan-400">5 Khoá</small>
                                </div>
                    ...
                    <div className="flex col-span-1 justify-content-center my-3 mx-3 nax-h-100 relative">
                        ...
                        <div className="bg-white text-center absolute bottom-0 right-0 py-2 px-3 m-1">
                            <h5>Hoá học</h5>
                            <small className="text-cyan-400">10 Khoá</small>
                        </div>
                ...
                <div className="grid grid-cols-3 my-3 mx-14 py-3 bg-green-sub-custom">
                    <div className="flex flex-col bg-white mx-2">
                        ...
                        <div className="text-center my-2">
                            <h3 className="mb-0">Đồ thị hàm số</h3>
                        ...
                        <div className="flex flex-row text-center mt-2">
                            ...
                            <div className= "w-1/3 bg-green-100 font-bold p-2 border-solid border">30 days</div>
                            <div className= "w-1/3 bg-green-100 font-bold p-2 border-solid border">50 Students</div>
                        </div>
                    </div>
                    <div className="flex flex-col bg-white mx-2">
                        <img
                        ...
                        />
                        <div className="text-center my-2">
                            <h3 className="mb-0">Dao động điều hoà</h3>
                            <div className="flex justify-content-center my-2">
                                <svg className="w-4 h-4 text-green-400 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                                    <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
                                </svg>
                        ...
                        <div className="flex flex-row text-center mt-2">
                            <div className= "w-1/3 bg-green-100 font-bold p-2 border-solid border">Mr.Tran</div>
                            <div className= "w-1/3 bg-green-100 font-bold p-2 border-solid border">45 days</div>
                            <div className= "w-1/3 bg-green-100 font-bold p-2 border-solid border">20 Students</div>
                        </div>
                    </div>
                    <div className="flex flex-col bg-white mx-2">
                        <img
                        ...
                        />
                        <div className="text-center my-2">
                            <h3 className="mb-0">Hoá hữu cơ</h3>
                            <div className="flex justify-content-center my-2">
                                <svg className="w-4 h-4 text-green-400 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                                    <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
                                </svg>
                        ...
                        <div className="flex flex-row text-center mt-2">
                            <div className= "w-1/3 bg-green-100 font-bold p-2 border-solid border">Mr.Bui</div>
                            <div className= "w-1/3 bg-green-100 font-bold p-2 border-solid border">100 days</div>
                            <div className= "w-1/3 bg-green-100 font-bold p-2 border-solid border">25 Students</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container 2xl mt-10">
                ...
                <div className="grid grid-cols-3 my-3 mx-14 py-3 bg-green-sub-custom ">
                    <div className="flex flex-col bg-white mx-2  ">
                        ...
                        />
                        <div className="text-center my-2">
                            <h3 className="mb-0">Mr.Nguyen</h3>
                            <div className="flex justify-content-center my-2">
                                <svg className="w-4 h-4 text-green-400 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                                    <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
                                </svg>
                            ...
                            <h5 className="px-2">Thầy giáo tận tâm với học sinh, bài giảng dễ hiểu, bài tập có lời giải và rất bổ ích</h5>
                        </div>
                    </div>
                    <div className="flex flex-col bg-white mx-2  ">
                        <img
                        ...
                        <div className="text-center my-2">
                            ...
                            <h5 className="px-2">Cô giáo tận tâm với học sinh, bài giảng dễ hiểu, bài tập có lời giải và rất bổ ích</h5>
                        </div>
                    </div>
                    <div className="flex flex-col bg-white mx-2  ">
                        <img
